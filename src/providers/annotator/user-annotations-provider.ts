...
export const userAnnotationsProvider = {
  ...
  async getReview(userId: string, taskId: string, annotationBatchId: string, reviewId: string) {
    const { data } = await userAnnotationsApi().getAnnotationReviewByUserTaskAnnotationBatch(userId, taskId, annotationBatchId, reviewId);
    return data;
  },
  async getReviews(userId: string, taskId: string, annotationBatchId: string) {
    const { data } = await userAnnotationsApi().getAnnotationReviewsByUserTaskAnnotationBatch(userId, taskId, annotationBatchId);
    return data;
  },
