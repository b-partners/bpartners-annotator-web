        ...
        <FormProvider {...form}>
            ...
            <DialogActions>
                <Stack width='100%' justifyContent='space-between' direction='row'>
                    <BpButton data-cy='reject-dialog-cancel-button' label='Annuler' isLoading={isLoading} onClick={closeDialog} />
                    <BpButton data-cy='reject-dialog-reject-button' label='Rejeter' isLoading={isLoading} onClick={handleReject} />
                </Stack>
            </DialogActions>
        </FormProvider>
    );
