...
import {
    rejectionCommentDefaultValues,
    rejectionCommentResolver,
} from '../../common/resolvers/rejection-comment-resolver';
                    ...
                    <Stack flexGrow={2}>
                        <List subheader={<ListSubheader>Versions de l'annotation</ListSubheader>}>
                            <Stack pt={2} pb={3} px={2}>
                                <TextField select value={dateFormater(batch.creationDatetime)} size='small' fullWidth>
                                    {batchs.map(batch => {
